...
class SurveyCard extends StatelessWidget {
  ...
  final VoidCallback? onTap; // 1. Bổ sung tham số onTap

  const SurveyCard({
    super.key,
    required this.entry,
    required this.onDelete,
    this.onTap, // 2. Nhận callback trong constructor
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      clipBehavior: Clip.antiAlias, // Giúp hiệu ứng bấm tràn sát góc bo Card
      child: InkWell(
        onTap: onTap, // 3. Bọc InkWell để phản hồi sự kiện click
        child: Padding(
